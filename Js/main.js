...
//Llamado a Funcion Historia
$("#nuestraHistoria").click(historia)

//Llamado a Funcion Valores
$("#botonValores").click(valores)

// Llamado a funcion continuar leyendo
$("#botonValoresContinuar").click(continuarLeyendo)
