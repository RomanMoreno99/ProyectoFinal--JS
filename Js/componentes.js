...
$(liHistoria1).text("El 3 de junio de 2017 Don Rouch Compañia Financiera abrio sus puertas en la Ciudad de Rosario.")

$(ulHistoria).append(liHistoria2)
$(liHistoria2).text("Don Rouch inició sus actividades como institución financiera no bancaria llegando a un centenar de personas.")
